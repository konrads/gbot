...
async function start(positionId){
    ...
    let tokenAmounts = await getTokenAmounts(
        poolInfo.liquidity,
        poolInfo.SqrtX96,
        poolInfo.tickLow,
        poolInfo.tickHigh,
...
//get Uni V3 position balances and earned fees
start(492126)